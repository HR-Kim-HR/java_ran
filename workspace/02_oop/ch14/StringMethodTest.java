...
public class StringMethodTest {
    public static void main(String[] args) {
        ...
        // 단, 대소문자는 구분하지 않습니다.
        System.out.println(str.toLowerCase().indexOf("java".toLowerCase())); // str 전체를 소문자로 바꾸고, "" 안의 알파벳 전체도 소문자로 바꾼 후, "" 안의 문자열이 str 에서 어느 위치에 있는지 출력
        System.out.println(str.toLowerCase().indexOf("Java".toLowerCase())); // 대소문자가 다르면 별개의 문자열로 취급하기 때문에 둘 다 소문자로 바꾸고 나서 인덱스 출력 가능
